class BlacklistURL:
    ...
    def connect_signals(self):
        # Add
        self.View.btn_init_add_url.clicked.connect(lambda: self.View.set_url("add"))
        ...
        # Edit
        self.View.btn_init_edit_url.clicked.connect(lambda: self.View.set_url("edit"))
        ...
        # Cancel
        self.View.btn_cancel_url.clicked.connect(lambda: self.View.set_url("read"))
