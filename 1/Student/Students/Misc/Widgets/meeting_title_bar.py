...
class TitleBar(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.btn_minimize.setStyleSheet("QPushButton{\n"
                                      ...
                                      f"    background-image: url({relative_path('Students', ['Misc', 'Resources'], 'minimize.png')});\n"
        ...
        self.btn_maximize_restore.setStyleSheet("QPushButton{\n"
                                        ...
                                        "    background: none;\n"
                                        "    background-repeat: none;\n"
                                        f"    background-image: url({relative_path('Students', ['Misc', 'Resources'], 'maximize.png')});\n"
                                        "    background-position: center center;\n"
                                        "}\n"
                                        "\n"
                                        "QPushButton:hover{\n"
    ...
    def set_maximum(self):
        ...
        self.btn_maximize_restore.setStyleSheet("QPushButton{\n"
                                                ...
                                                "    background: none;\n"
                                                "    background-repeat: none;\n"
                                                f"   background-image: url({relative_path('Students', ['Misc', 'Resources'], 'restore.png')});\n"
                                                "    background-position: center center;\n"
                                                "}\n"
                                                "\n"
                                                "QPushButton:hover{\n"
