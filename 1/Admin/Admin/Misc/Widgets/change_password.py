...
from Admin.Misc.Widgets.custom_lineedit import AdminPassword
...
class ChangePassword(QtWidgets.QDialog):
    ...
    def connect_signals(self):
        ...
        self.update_password.operation.connect(lambda: self.Lobby.set_admin_status_handler('Password updated successfully'))
