...
class TeacherAttendance:
    ...
    def ImportTeachersTable(self):
        handler = ImportTeacherTable(self.Model, self.Admin.Controller.SignInController.SignIn.show_alert)
    ...
    def ExportTeacher(self):
        handler = ExportTeacher(self.Model.export_teacher_table, self.Admin.Controller.SignInController.SignIn.show_alert)
        handler.started.connect(self.View.TableTeacherLoadingScreen.run)
        handler.finished.connect(self.View.TableTeacherLoadingScreen.hide)
        return handler
