...
class ClassMember:
    ...
    def ImportClassesMembersTable(self):
        handler = ImportClassesMembersTable(self.Model, self.Admin.Controller.SignInController.SignIn.show_alert)
    ...
    def ExportClassesMembers(self):
        handler = ExportClassesMembers(self.Model.export_classes_members_table, self.Admin.Controller.SignInController.SignIn.show_alert)
        handler.started.connect(self.View.TableClassLoadingScreen.run)
        handler.finished.connect(self.View.TableClassLoadingScreen.hide)
        return handler
