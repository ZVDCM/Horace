...
class AlertItem(QtWidgets.QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.icon.setText("")
        self.icon.setPixmap(QtGui.QPixmap(relative_path('Teachers', ['Misc', 'Resources'], self.photo)))
    ...
    def enterEvent(self, event):
        self.lbl_close.setPixmap(QtGui.QPixmap(relative_path('Teachers', ['Misc', 'Resources'], 'close_2.png')))
